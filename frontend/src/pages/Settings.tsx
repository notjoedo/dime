...
import { MdEdit, MdEmail, MdPhone, MdLanguage, MdClose, MdAdd } from 'react-icons/md'
...
import PostmatesIcon from '../public/Postmates.svg'
import UberIcon from '../public/Uber.svg'
import BloomingdalesIcon from '../public/Bloomingdales.svg'
...
import MacysIcon from '../public/Macys.svg'
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', gap: '16px', minWidth: 'max-content' }}>
            ...
            {[
              ...
              { icon: GrubhubIcon, name: 'Grubhub' },
              { icon: PostmatesIcon, name: 'Postmates' },
              { icon: UberIcon, name: 'Uber' },
              { icon: BloomingdalesIcon, name: 'Bloomingdales' },
              { icon: SpotifyIcon, name: 'Spotify' },
              { icon: AppleIcon, name: 'Apple' },
              { icon: PrimeIcon, name: 'Prime' },
              { icon: LyftIcon, name: 'Lyft' },
              { icon: MacysIcon, name: 'Macys' },
              { icon: DoordashIcon, name: 'Doordash' },
              { icon: UberEatsIcon, name: 'UberEats' },
            ].map((merchant) => (
              <div
                key={merchant.name}
                style={{
